...
execute as @a at @e[name=Compass] if block ~ ~ ~ minecraft:campfire facing entity @p eyes at @e[name=Compass] run execute in spatial_tent:spatial_tent run clone ~-2 ~-2 ~2 ~2 ~3 ~8 0 249 0
