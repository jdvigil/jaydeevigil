...
execute as @a at @e[name=Compass] if block ~ ~ ~ minecraft:campfire facing entity @p eyes at @e[name=Compass] run setblock ~ ~ ~-2 minecraft:spruce_trapdoor[facing=south, half=top, open=true]
execute as @a at @e[name=Compass] if block ~ ~ ~ minecraft:campfire facing entity @p eyes at @e[name=Compass] run setblock ~ ~ ~-6 minecraft:spruce_trapdoor[facing=south, half=top, open=true]
...
execute as @a at @e[name=Compass] if block ~ ~ ~ minecraft:campfire facing entity @p eyes at @e[name=Compass] run summon minecraft:armor_stand ~ ~ ~-6 {CustomName:"\"tp_armorstand_1\"",Invisible:1}
execute as @a at @e[name=Compass] if block ~ ~ ~ minecraft:campfire facing entity @p eyes at @e[name=Compass] run summon minecraft:armor_stand ~ ~-3 ~-3 {CustomName:"\"tp_armorstand_2\"",Invisible:1}
